...
the time it takes to create analysable datasets.
...
Data Tabulation Model) data stored by IDDO. MAPPER data from IDDO is not
supported in this package.

Functions are documented and have example code. A
